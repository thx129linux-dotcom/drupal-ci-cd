...
class ViewHooks {
  ...
  public static function themeSuggestionsViewsViewUnformattedAlter(array &$suggestions, array $variables) {
    // Add a suggestion based on the view name and the current display.
    $view = $variables['view'];
    $name = $view->id();
    $display = $view->current_display;
  ...
  public static function themeSuggestionsViewsExposedFormAlter(array &$suggestions, array $variables) {
